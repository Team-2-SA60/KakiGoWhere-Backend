...
public interface RatingRepository extends JpaRepository<Rating, Long> {
    ...
    Optional<Rating> findByPlaceIdAndTouristId(@Param("placeId") long placeId,
...
""")
    Optional<RatingItemDTO> findMyRatingItemDTO(@Param("placeId") long placeId,
                                                @Param("touristId") long touristId);
    ...
    @Query("""
        ...
        WHERE r.place.id = :placeId
          AND r.tourist.id <> :touristId
    """)
    List<RatingItemDTO> findOtherRatingItemDTOs(@Param("placeId") long placeId,
                                                @Param("touristId") long touristId);
}